...
def plot_2d(X, Y, Z, xax='', yax='', save='2_D', titles=[], fs=50, cbx=[0.9, 0.28, 0.05, 0.46], pad=-20, size=(30,30), trans=True, cont=3, ticks=np.arange(-180,180,10), label='Delta E (kcal/mol)'):
